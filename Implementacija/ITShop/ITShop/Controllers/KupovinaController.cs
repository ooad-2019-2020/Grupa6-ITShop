...
namespace ITShop.Controllers
{
    public class KupovinaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DatumTransakcije,Iznos")] Kupovina kupovina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DatumTransakcije,Iznos")] Kupovina kupovina)
        {
            if (id != kupovina.Id)
            {
                return NotFound();
