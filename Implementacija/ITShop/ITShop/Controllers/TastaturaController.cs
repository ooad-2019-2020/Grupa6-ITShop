...
namespace ITShop.Controllers
{
    public class TastaturaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VrstaPrikljucka,Id,ProizvodId")] Tastatura tastatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VrstaPrikljucka,Id,ProizvodId")] Tastatura tastatura)
        {
            if (id != tastatura.Id)
            {
                return NotFound();
