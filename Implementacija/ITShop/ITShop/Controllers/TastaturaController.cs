...
namespace ITShop.Controllers
{
    public class TastaturaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VrstaPrikljucka")] Tastatura tastatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VrstaPrikljucka")] Tastatura tastatura)
        {
            if (id != tastatura.Id)
            {
                return NotFound();
