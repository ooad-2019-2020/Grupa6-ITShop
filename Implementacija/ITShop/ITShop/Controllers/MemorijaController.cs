...
namespace ITShop.Controllers
{
    public class MemorijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Kolicina,Id,ProizvodId")] Memorija memorija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Kolicina,Id,ProizvodId")] Memorija memorija)
        {
            if (id != memorija.Id)
            {
                return NotFound();
