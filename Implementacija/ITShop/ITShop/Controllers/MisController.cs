...
namespace ITShop.Controllers
{
    public class MisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VrstaPrikljucka,DuzinaKabla,DodatneTipke")] Mis mis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VrstaPrikljucka,DuzinaKabla,DodatneTipke")] Mis mis)
        {
            if (id != mis.Id)
            {
                return NotFound();
