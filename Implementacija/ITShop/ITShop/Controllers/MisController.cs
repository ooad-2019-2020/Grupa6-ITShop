...
namespace ITShop.Controllers
{
    public class MisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProizvodId,VrstaPrikljucka,DuzinaKabla,DodatneTipke")] Mis mis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProizvodId,VrstaPrikljucka,DuzinaKabla,DodatneTipke")] Mis mis)
        {
            if (id != mis.Id)
            {
                return NotFound();
