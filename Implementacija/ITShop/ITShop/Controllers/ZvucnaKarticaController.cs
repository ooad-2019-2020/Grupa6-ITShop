...
namespace ITShop.Controllers
{
    public class ZvucnaKarticaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProizvodId")] ZvucnaKartica zvucnaKartica)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProizvodId")] ZvucnaKartica zvucnaKartica)
        {
