...
namespace ITShop.Controllers
{
    public class DiskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DiskId,ProizvodId,Kapacitet,Brzina")] Disk disk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiskId,ProizvodId,Kapacitet,Brzina")] Disk disk)
        {
            if (id != disk.DiskId)
            {
                return NotFound();
