...
namespace ITShop.Controllers
{
    public class UposlenikController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DatumZaposljenja,Id,KorisnikId")] Uposlenik uposlenik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DatumZaposljenja,Id,KorisnikId")] Uposlenik uposlenik)
        {
            if (id != uposlenik.Id)
            {
                return NotFound();
