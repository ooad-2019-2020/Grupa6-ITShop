...
namespace ITShop.Controllers
{
    public class ProizvodController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Naziv,Proizvodjac,Cijena,Id,Slika")] Proizvod proizvod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Naziv,Proizvodjac,Cijena,Id,Slika")] Proizvod proizvod)
        {
            if (id != proizvod.Id)
            {
                return NotFound();
