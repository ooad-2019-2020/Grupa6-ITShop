...
namespace ITShop.Controllers
{
    public class KucisteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProizvodId,Zapremina,BrojPortova")] Kuciste kuciste)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProizvodId,Zapremina,BrojPortova")] Kuciste kuciste)
        {
            if (id != kuciste.Id)
            {
                return NotFound();
